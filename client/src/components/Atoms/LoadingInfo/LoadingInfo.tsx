  ...
  return (
    <Wrapper>
      <svg width="299" height="301" viewBox="0 0 299 301" fill="none">
        <g id="Radar">
          <circle id="Ellipse 56" cx="149.5" cy="149.5" r="148" fill="#2D4C23" stroke="#00ED00" stroke-width="3" />
          <circle id="Ellipse 57" cx="150" cy="149" r="110.5" stroke="#00ED00" stroke-width="3" />
          <path
            id="Ellipse 58"
          ...
          <g id="Object3" filter="url(#filter1_f_134_21)">
            ...
            <circle cx="124.5" cy="265.5" r="5.5" stroke="#00ED00" stroke-width="2" />
          </g>
          <g id="Object1" filter="url(#filter2_f_134_21)">
            <circle cx="70.5" cy="103.5" r="4.5" fill="#E1FFCA" />
            <circle cx="70.5" cy="103.5" r="5.5" stroke="#00ED00" stroke-width="2" />
          </g>
          <g id="Object2" filter="url(#filter3_f_134_21)">
            <circle cx="236.5" cy="121.5" r="4.5" fill="#E1FFCA" />
            <circle cx="236.5" cy="121.5" r="5.5" stroke="#00ED00" stroke-width="2" />
          </g>
        </g>
        <defs>
          <filter id="filter0_f_134_21" x="74" y="145" width="161.5" height="155.5" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_134_21" />
          </filter>
          <filter id="filter1_f_134_21" x="114" y="255" width="21" height="21" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_134_21" />
          </filter>
          <filter id="filter2_f_134_21" x="60" y="93" width="21" height="21" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_134_21" />
          </filter>
          <filter id="filter3_f_134_21" x="226" y="111" width="21" height="21" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_134_21" />
          </filter>
          <linearGradient id="paint0_linear_134_21" x1="110.5" y1="237.5" x2="187.637" y2="264.054" gradientUnits="userSpaceOnUse">
            <stop stop-color="#43C500" />
            <stop offset="0.92397" stop-color="#206C01" stop-opacity="0.14" />
          </linearGradient>
        </defs>
      </svg>
